<nav class="navbar navbar-expand-lg navbar-light bg-dark ">
    <button class="btn text-light" id="menu-toggle">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            <li class="nav-item">
            <a class="btn btn-outline-light" href="../model/admin-logout.php">LOGOUT</a>


            </li>
            <!-- <li class="nav-item dropdown">
                <a class="nav-link font-italic" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
